define('components/demo/add_label/add_label', ['component_modules/avalon/avalon.modern.shim', 'lib/text!http://127.0.0.1:8008/static/components/demo/add_label/add_label.html', 'components/modules/validate_mvvm/validate_mvvm', 'components/modules/toast/toast', 'components/modules/myajax/myajax', 'components/common/js/tool', 'component_modules/sortable/Sortable', 'lib/css!http://127.0.0.1:8008/static/components/demo/add_label/add_label.css'], function(avalon, template, validate, Toast, MyAjax, TOOL, Sortable) {
	var vm = {},
		v = validate({}),
