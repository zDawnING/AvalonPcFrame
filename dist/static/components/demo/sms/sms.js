define('components/demo/sms/sms', ['component_modules/avalon/avalon.modern.shim', 'lib/text!http://127.0.0.1:8008/static/components/demo/sms/sms.html', 'components/modules/validate_mvvm/validate_mvvm', 'components/modules/toast/toast', 'components/modules/myajax/myajax', 'components/common/js/tool'], function(avalon, template, validate, Toast, MyAjax, TOOL) {
	var vm = {},
		v = validate({}),
