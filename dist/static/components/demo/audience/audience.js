define('components/demo/audience/audience', ['component_modules/avalon/avalon.modern.shim', 'lib/text!http://127.0.0.1:8008/static/components/demo/audience/audience.html', 'components/modules/toast/toast', 'components/modules/myajax/myajax', 'components/common/js/tool', 'components/modules/validate_mvvm/validate_mvvm', 'component_modules/layer/layer.min', 'components/demo/audience/countryCode', 'lib/css!http://127.0.0.1:8008/static/components/demo/audience/audience.css'], function(avalon, template, Toast, MyAjax, TOOL, validate, layer, countryCode) {
	var vm = {},
		v = {},
	...
	avalon.component("ms:audiencemodal", {
		...
		$ready: function() {
			require(['components/modules/city_three_select_pc/city_three_select_pc'], function() {});
		},
