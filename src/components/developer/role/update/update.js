define(['avalon',
	'text!com/developer/role/update/update.html',
	'com/developer/role/common/status',
	'validate',
	'toast',
	'myajax'
	...
	update_vm.$watch('obj.r_role_name', function(newValue, oldValue) {
		update_vm.is_locked_btn = !is_changed();
	});
    update_vm.$watch('obj.r_description', function(newValue, oldValue) {
		update_vm.is_locked_btn = !is_changed();
	});
	...
	var $map = {
		...
		onSuccess: function() {
			...
			param_array.push({
				key: 'role_id',
				value: update_vm.obj.role_id
			});
			param_array.push({
				key: 'r_role_name',
				value: update_vm.obj.r_role_name,
			});
            param_array.push({
				key: 'r_description',
				value: update_vm.obj.r_description,
			});
