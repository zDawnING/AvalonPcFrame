define(['avalon',
	'text!com/developer/department/add/add.html',
	'com/developer/department/common/status',
	'validate',
	'toast',
	'myajax',
	'tool',
	...
	var $map = {
		...
		onSuccess: function() {
			...
			param_array.push({
				key: 'dep_name',
				value: add_vm.obj.dep_name,
			});
			
			
			param_array.push({
				key: 'dep_parent_id',
				value: add_vm.obj.dep_parent_id,
			});	
            param_array.push({
				key: 'dep_user_id',
				value: add_vm.obj.dep_user_id,
			});	
            param_array.push({
				key: 'dep_description',
				value: add_vm.obj.dep_description,
			});             
