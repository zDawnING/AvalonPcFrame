define(['avalon',
	'text!com/developer/user_group/set_rule/set_rule.html',
	'validate',
	'toast',
	'myajax',
	'tool',
	'css!com/developer/user_group/set_rule/set_rule.css',
	'css!checkbox_css'
	...
	avalon.component("ms:rulemodal", {
		...
		load_rule: function(id) {
			...
			MyAjax(URL.load_rule, param_array, function(data) {
